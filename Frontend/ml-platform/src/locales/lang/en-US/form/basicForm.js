export default {
  ...
  'form.basic-form.basic.description':
   'This page is where you can add a model file after filling the required infomation.',
  'model_list_guideline': 'This page lists all models you have already added.',
  'model_test_guideline': 'Test your model with required parameters and see the results.',
  'form.basic-form.title.label': 'Model name',
  'form.basic-form.title.placeholder': 'Give your model a name',
  ...
  'form.basic-form.goal.label': 'Model description',
  'form.basic-form.goal.placeholder': 'Please enter some descriptions of your model',
